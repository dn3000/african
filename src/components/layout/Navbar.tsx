    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 glass ${
          scrolled ? "border-b border-[#F5F5F5]/10" : "border-b border-transparent"
        }`}
      >
          ...
          <div className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                ...
                className={`relative text-sm font-[family-name:var(--font-montserrat)] font-medium tracking-wide transition-colors duration-200 pb-1 ${
